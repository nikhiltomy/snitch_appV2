  ...
  <div id="category">
    ...
    <div class="navbar section">
      <div class="navbar__main">
        <div class="navbar__counter nreset-margin">
        ...
        <div class="navbar__sort desktop-only nreset-margin nresetsort">
          <span class="navbar__label">{{ $t("") }}</span>
          <SfSelect
    ...
    <div class="main section ">
      ...
      <SfLoader :class="{ loading }" :loading="loading">
        <div class="products" v-if="!loading">
          ...
          <Productgrid1 :products="products"></Productgrid1>
          <div
...
import { computed, onMounted, onBeforeUpdate } from "@vue/composition-api";
